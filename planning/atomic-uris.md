...
[`device-pairing.md`](./device-pairing.md) (`atomic:pair` / today
`atomic://pair`), [`node-did-canonicalization.md`](./node-did-canonicalization.md)
(node ID form — update when this ships).
